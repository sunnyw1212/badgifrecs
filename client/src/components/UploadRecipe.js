...
class UploadRecipe extends Component {
 ...
 let newState = Object.assign({}, this.state);
  ...
  this
    .props
    .createRecipePost({user: this.props.currentUser.user, recipe_gif: recipe_gif, recipe_title: recipe_title, recipe_description: recipe_description, recipe_instructions: arr_recipe_instructions});
}
...
return {new: state.recipeposts.new, currentUser: state.users.currentUser}
}

function mapDispatchToProps(dispatch) {
return bindActionCreators({
  createRecipePost: createRecipePost
}, dispatch);
}
