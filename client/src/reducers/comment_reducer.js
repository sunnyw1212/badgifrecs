import { 
	CREATE_COMMENT_LOAD, CREATE_COMMENT_SUCCESS, CREATE_COMMENT_FAIL,
	RESET_NEW_COMMENTS
} from '../actions/index';

const INITIAL_STATE = {
	newComments: { comments: [], error: null, loading: false}
};
...
export default function( state=INITIAL_STATE, action ){
	...
	switch(action.type){
		...
		//reset newcomments state whenever you chagne View component and the component unmounts
