import { 
	REGISTER_USER_LOAD, REGISTER_USER_SUCCESS, REGISTER_USER_FAIL,
	LOGIN_USER_LOAD, LOGIN_USER_SUCCESS, LOGIN_USER_FAIL,
	LOGOUT
} from '../actions/index';
...
const INITIAL_STATE = {
	currentUser: { user: persistedState, error: null, loading: false}
};
...
export default function( state=INITIAL_STATE, action ){
	...
	switch( action.type ){
		...
		case LOGOUT:
			console.log('LOGGED OUT IN REDUCER YO')
			return Object.assign({}, state, {
				currentUser: {
					user: null,
					error: null, 
